  ...
  if (mode === 'quadratic') {
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700 transition-all duration-700">
        <QuadraticCalculator onStandardCalcClick={() => setMode('standard')} />
      </div>
    );
  }

  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700 transition-all duration-700 relative overflow-hidden">
      {/* Animated background */}
      ...
      {/* Math animation background */}
      <div className="pointer-events-none absolute inset-0 -z-20">
        <svg width="100%" height="100%" viewBox="0 0 800 600" className="w-full h-full opacity-40">
          <g className="animate-move1">
            <text x="100" y="120" fontSize="32" fill="#fff8" fontFamily="monospace">E = mc²</text>
            <text x="600" y="80" fontSize="28" fill="#fff7" fontFamily="monospace">π ≈ 3.1416</text>
            <text x="200" y="500" fontSize="24" fill="#fff6" fontFamily="monospace">a² + b² = c²</text>
          </g>
          <g className="animate-move2">
            <text x="400" y="300" fontSize="40" fill="#fff5" fontFamily="monospace">∫ x dx</text>
            <text x="700" y="550" fontSize="22" fill="#fff6" fontFamily="monospace">Σ n=1^∞ 1/n²</text>
          </g>
          <g className="animate-move3">
            <circle cx="650" cy="200" r="32" fill="none" stroke="#fff4" strokeWidth="2" />
            <rect x="120" y="400" width="48" height="48" fill="none" stroke="#fff3" strokeWidth="2" rx="12" />
          </g>
        </svg>
      </div>
